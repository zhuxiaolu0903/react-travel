...
import { getRecommendProductDataActionCreator } from '../../redux/recommendProducts/recommendProductsActions'
      ...
      <MainLayout>
        <div className={styles['page-content']}>
          ...
          {loading ? (
            ...
            /*景点推荐*/
            <div
              className={`${styles['hot-attractions']} ${styles['attractions-introduce']}`}
            >
              <Typography.Title level={3}>
                {t('home_page.popular_attractions')}
              </Typography.Title>
              {/*景点标题切换*/}
                ...
                <Space size="small">
                  {productList1.map((product, index) => (
                    <div
                      ...
                      className={
                        this.state.curTabIndex === index
                          ? `${styles['active']} ${styles['attractions-item-box']}`
                          : styles['attractions-item-box']
                      }
              ...
              <div className={styles['attractions-container']}>
                <ProductCollection
                  list={productList1[this.state.curTabIndex].list}
                />
              </div>
              {/*游世界*/}
              <Typography.Title level={3}>
                {t('home_page.travel_world')}
              </Typography.Title>
              <div className={styles['attractions-container']}>
                <Row gutter={16}>
                  <Col span={5}>
              ...
              {/*周边游*/}
              <Typography.Title level={3}>
                {t('home_page.travel_around_border')}
              </Typography.Title>
              <div className={styles['attractions-container']}>
                <Space
                  direction={'vertical'}
